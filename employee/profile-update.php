...
if(isset($_POST['update_profile'])) {
	...
	try {	
		...
		$statement = $db->prepare("SELECT * FROM employee_list WHERE username=?");
		...
		if($_POST['new1'] != $_POST['new2'])
		{
			...
			$statement = $db->prepare("UPDATE employee_list SET employee_pic=?, firstname=?,lastname=?,contact_number=?,  address=?, password=?  WHERE username='$username'");
	...
	<div id="site_content">	
		<div class="main2">
			<div class="main_registraion">
				...
				<table>
					<tr>
						<td class="profile_image"><strong>Update Profile Picture :&nbsp;&nbsp;&nbsp;</strong><input type="file" name="employee_pic" ></td>
					</tr>				
				<tr class="f_name">
