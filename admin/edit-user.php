...
if(isset($_POST['update_user'])) {
	...
	try {
		...
		$statement = $db->prepare("UPDATE user_list SET  firstname=?, lastname=?, job_cat=?, sex=?, birthday=?, contact_num=?, account_num=?, address=?, password=?  WHERE user_id=?");
		$statement->execute(array($_POST['firstname'],$_POST['lastname'],$_POST['job_cat'],$_POST['sex'],$birthday,$_POST['contact_num'],$_POST['account_num'],$_POST['address'],$new_final_password,$user_id));
...
<?php include('header.php');?>
	...
	<form action="" method="post">
		...
		<tr>
		<td>
			<select class="short" name="job_cat">
				<option value=""><?php echo $job_cat; ?></option>
			</select>
		</td>
		</tr>
		<tr>
		...
		<tr>
			<td><input type="submit" value="SAVE" name="update_user"></td>
		</tr>
		</table>
