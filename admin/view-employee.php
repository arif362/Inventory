...
$success_message2 = "Employee Profile has been deleted successfully.";
...
<table class="tbl2" width="100%">
	...
	{		
		...
		<tr>
		<td><a href="../uploads/<?php echo $row['employee_pic']; ?>"><img  src="../uploads/<?php echo $row['employee_pic']; ?>" alt="Photo" width="230" height="280"/></a></td>
		</tr>
		<tr>
			<td>Firstname</td>
		</tr>
		...
		<tr>
			...
			&nbsp;|&nbsp;
			<a href="edit-employee.php?employee_id=<?php echo $row['employee_id']; ?>">Edit</a>
			&nbsp;|&nbsp;
			<a onclick='return confirmDelete();' href="view-employee.php?employee_id=<?php echo $row['employee_id']; ?>"><img src="../images/delete.gif"></a></td>
