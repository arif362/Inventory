...
if(isset($_POST['update_employee'])) {
	...
	try {
		...
		$statement = $db->prepare("SELECT * FROM member_list WHERE employee_id=?");
		...
		$statement = $db->prepare("UPDATE employee_list SET  firstname=?, lastname=?, designation=?, sex=?, birthday=?, contact_number=?, account_number=?, address=?, password=?  WHERE employee_id=?");
		$statement->execute(array($_POST['firstname'],$_POST['lastname'],$_POST['designation'],$_POST['sex'],$birthday,$_POST['contact_num'],$_POST['account_num'],$_POST['address'],$new_final_password,$employee_id));
...
<?php include('header.php');?>
	...
	<form action="" method="post">
		...
		<td>
			...
			<option value=""><?php echo $designation;?></option>
