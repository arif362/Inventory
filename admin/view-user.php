...
$statement = $db->prepare("DELETE FROM user_list WHERE user_id=?");
$statement->execute(array($user_id));

$success_message2 = "User Profile has been deleted successfully.";
...
<table class="tbl2" width="100%">
	...
	<?php
		...
		$i=0;
		$statement = $db->prepare("SELECT * FROM user_list ORDER BY user_id DESC");
		$statement->execute();
		$total_pages = $statement->rowCount();
			...
			$statement = $db->prepare("SELECT * FROM user_list ORDER BY user_id DESC LIMIT $start, $limit");
			$statement->execute();
	...
	foreach($result as $row)
	{
					...
					$statement = $db->prepare("SELECT * FROM user_list ORDER By user_id");
					$statement->execute();
					$result = $statement->fetchAll(PDO::FETCH_ASSOC);
		...
		<tr>
		<td><?php echo $i; ?></td>
		<td><a href="../uploads/<?php echo $row['user_pic']; ?>"><img class="Pimg" src="../uploads/<?php echo $row['user_pic']; ?>" alt="" width="150" height="150"/></a></td>
		...
		<tr>
		<td><a href="../uploads/<?php echo $row['user_pic']; ?>"><img  src="../uploads/<?php echo $row['user_pic']; ?>" alt="Photo" width="230" height="280"/></a></td>
		</tr>
		<tr>
			<td>Firstname</td>
		</tr>
		...
		<tr>
			<td><input class="short" type="text" name="job_cat" value="<?php echo $job_cat;?>" ></td>		
		...
		<tr>
				<td>
					<input  class="short" type="text" name="birthday" value="<?php echo $birthday;?>" >	
				</td>
		</tr>
		<tr>
		...
		<tr>
			...
			&nbsp;|&nbsp;
			<a href="edit-user.php?user_id=<?php echo $row['user_id']; ?>">Edit</a>
			&nbsp;|&nbsp;
			<a onclick='return confirmDelete();' href="view-user.php?user_id=<?php echo $row['user_id']; ?>"><img src="../images/delete.gif"></a></td>
