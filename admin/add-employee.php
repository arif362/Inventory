...
if(isset($_POST['add_employee'])) {
	...
	try {
		...
		$statement = $db->prepare("INSERT INTO employee_list (username,firstname,lastname,type,designation,sex,birthday,contact_number,account_number,address,email,password,add_date) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
<?php include('header.php');?>
	...
	<form action="" method="post">
		...
		<tr>
			<td><input type="submit" value="SAVE" name="add_employee"></td>
		</tr>
		</table>	
	</form>
