...
if(isset($_POST['form_login'])) {
	...
	try {
		...
		$num=0;
		$statement = $db->prepare("SELECT * FROM user_list WHERE username=? and password=? and user_type='General User' ORDER BY user_id");
		...
		{	
			...
			header('location: general-user/index.php');
